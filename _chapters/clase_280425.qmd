...
#### Advanced Example: Waiting-Time Distribution

Let $S_n$ denote the waiting time until the $n$th arrival. The sum of $n$ i.i.d. exponential random variables is gamma distributed:
