...
Suppose an urn contains 6 red and 4 black balls ($10$ total). Two balls are drawn in sequence **without replacement**. Compute the total number of ordered outcomes:
...
**Link to Probability Spaces:**
If instead balls were drawn **with replacement** (each draw independent), the total number of ordered pairs would be $10 \times 10 = 100$, illustrating the effect of independence.
...
Arrange $5$ distinct books on a shelf. The number of arrangements is $5! = 120$.

#### Advanced Example

**Permutation Parity:**
For $n \geq 2$, half of all permutations are even and half are odd, a result crucial in the theory of determinants and algebraic structures [@Durrett2019].
